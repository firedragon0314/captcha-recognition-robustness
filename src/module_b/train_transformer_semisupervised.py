...
def train_one_epoch(model, data_loader, criterion, optimizer, device):
    ...
    progress = tqdm(
        data_loader,
        desc="B-2 Semi-supervised Transformer Training",
        leave=False
    )
...
def main():
    ...
    parser.add_argument("--pseudo_csv", type=str,
                        default="data_semi/pseudo/pseudo_labels_transformer.csv")
    ...
    parser.add_argument(
        "--experiment_name",
        type=str,
        default="b2_semi_student_pseudo_transformer_ctc"
    )
    ...
    config = {
        ...
        "description": (
            "B-2 semi-supervised learning (student). "
            "30% labeled CAPTCHA data are trained with true CTC labels. "
            "70% unlabeled CAPTCHA data are trained using pseudo-labels "
            "generated by a teacher CNNTransformerCTC model."
        ),
        "charset": CHARS,
    ...
    print("=" * 70)
    print("B-2 Training Method 3: Semi-supervised Learning (Student)")
    print("CNN + Transformer Encoder + CTC")
    print("=" * 70)
    print(f"Experiment directory: {exp_dir}")
    print(f"Labeled 30% dir: {args.labeled_dir}")
    print(f"Pseudo labels CSV: {args.pseudo_csv}")
    print(f"Train samples (labeled + pseudo): {len(train_dataset)}")
    ...
    print("\nB-2 semi-supervised Transformer training finished.")
