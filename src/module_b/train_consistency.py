...
def train_one_epoch(
    ...
    progress = tqdm(data_loader, desc="Consistency Training", leave=False)
    ...
    for view1, view2, labels, label_lengths, _, _ in progress:
        ...
        ctc_loss_1 = ctc_loss_for_logits(
            logits1,
            labels,
            label_lengths,
            criterion,
        ...
        ctc_loss_2 = ctc_loss_for_logits(
            logits2,
            labels,
            label_lengths,
            criterion,
    ...
    return {
        ...
        "train_consistency_loss": total_consistency_loss / max(total_batches, 1)
    }
...
def main():
    ...
    exp_dir = create_experiment_dir(
        ...
        prefix="train",
        name="self_supervised_consistency_crnn"
    )
    ...
    config = {
        ...
        "description": (
            ...
            "the CRNN model. CTC Loss is applied to both views, and feature "
            "consistency loss is used to make the sequence representations stable "
            "under augmentation."
        ),
        "loss": {
            "total_loss": "CTC Loss(view1) + CTC Loss(view2) + lambda * Feature Consistency Loss",
            "ctc_loss": "Supervised sequence recognition loss",
            "feature_consistency_loss": "Self-supervised MSE loss between normalized feature vectors",
    ...
    print("=" * 70)
    print("B-1 Training Method 4: Self-supervised Augmentation Consistency")
    print("=" * 70)
    ...
    print("\nSelf-supervised consistency training finished.")
