...
def train_one_epoch(model, data_loader, criterion, optimizer, device):
    ...
    progress = tqdm(data_loader, desc="B-2 Transformer Training", leave=False)
...
def main():
    ...
    parser.add_argument(
        "--experiment_name",
        type=str,
        default="b2_supervised_cnn_transformer_ctc"
    )
    ...
    config = {
        ...
        "description": (
            "B-2 supervised baseline. The model uses a CNN feature extractor "
            "followed by a Transformer Encoder and CTC Loss. It takes the full "
            "CAPTCHA image as input and predicts the full sequence label without "
    ...
    print("=" * 70)
    print("B-2 Experiment 1: Supervised CNN + Transformer Encoder + CTC")
    print("=" * 70)
    ...
    print("\nB-2 supervised Transformer training finished.")
