...
from dataset_pseudo import SemiSupervisedCaptchaDataset, semi_supervised_collate_fn
...
def train_one_epoch(model, data_loader, criterion, optimizer, device):
    ...
    progress = tqdm(data_loader, desc="Semi-supervised Training", leave=False)
...
def main():
    ...
    parser.add_argument("--labeled_dir", type=str, default="data_semi/labeled_30")
    parser.add_argument("--pseudo_csv", type=str, default="data_semi/pseudo/pseudo_labels.csv")
    ...
    exp_dir = create_experiment_dir(
        ...
        prefix="train",
        name="semi_student_pseudo_label_crnn"
    )

    train_dataset = SemiSupervisedCaptchaDataset(
    ...
    config = {
        ...
        "module": "B-1",
        "training_method": "Semi-supervised Learning",
        "description": "30% labeled CAPTCHA data are trained with true labels, while 70% unlabeled CAPTCHA data are trained using pseudo-labels generated by a teacher CRNN model.",
        "dataset": {
            "labeled_dir": args.labeled_dir,
            "pseudo_csv": args.pseudo_csv,
    ...
    print("=" * 70)
    print("B-1 Training Method 3: Semi-supervised Learning")
    print("=" * 70)
    print(f"Experiment directory: {exp_dir}")
    print(f"Labeled 30% dir: {args.labeled_dir}")
    print(f"Pseudo labels: {args.pseudo_csv}")
